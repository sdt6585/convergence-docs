...
<script>
  ...
  import PlayerShipsComponent from './player-ships-component.svelte';
  import NpcShipsComponent from './npc-ships-component.svelte';
  import ActionPanelComponent from './action-panel-component.svelte';;
